  ...
  fluidPage(
    ...
    navbarPage(
      ...
      title = a(img(
        ...
        src = paste0("http://",my_qiime_ip, ":3811", "/mochi_title_white.png"),
               ...
               sidebarLayout(
                 ...
                 sidebarPanel(
                   ...
                   div(id = "TA_MOCHI_ui",
                                        ...
                                        tippy::tippy_this(elementId = "info_taxatable", tooltip = "<span style='font-size:20px;'>Downloaded from taxonomy classification</span>", placement = "right", allowHTML = T),
                                        ...
                                        fileInput(inputId = "table_dada2_upload",
                                                  ...
                                                  multiple = F,
                                                  accept = ".qza"),
                                        tippy::tippy_this(elementId = "info_ASVs", tooltip = "<span style='font-size:20px;'>Downloaded from taxonomy classification</span>", placement = "right", allowHTML = T),
                   ...
                   tabsetPanel(type = "tabs",
                               ...
                               tabPanel(title = "Beta diversity",
                                        ...
                                        div(
                                          ...
                                          radioButtons(inputId = "sep", 
                                                       ...
                                                       inline = T),
                                          radioButtons(inputId = "beta_x_axis", label = "Select the x axis", choices = paste0("PC", 1:6), inline = T),
                                          radioButtons(inputId = "beta_y_axis", label = "Select the y axis", choices = paste0("PC", 2:6), inline = T),
                                          radioButtons(inputId = "beta_z_axis", label = "Select the z axis", choices = paste0("PC", 3:6), inline = T,),
                               ...
                               tabPanel(title = "Phylogenetic diversity",
                                        ...
                                        div(
                                          ...
                                          # br(),br(), 
                                          # fileInput(inputId = "table_dada2_upload", 
                                          #           label = "Upload the feature table (Downloaded from Taxonomy Anlysis)",
                                          #           multiple = F,
                                          #           accept = ".qza", 
                                          #           width = "40%"),
    ...
    tags$footer(
      tags$span(
        ...
        " National Yang Ming Chiao Tung University, Taiwan 300, R.O.C.,", " last updated on 05/21/2022"),
